      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-navy/30 focus:border-navy"
                  placeholder="••••••••"
                  required
          ...
          <p className="text-center text-sm text-gray-500">
            New here?{' '}
            <Link to="/register" className="text-coral font-semibold">Create account</Link>
          </p>
        </div>
      </div>
    </div>
